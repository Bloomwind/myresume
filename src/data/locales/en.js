export const enLocale = {
  ...
  branding: {
    ...
    typingBrandSequence: ['initializing portfolio...', 'loading profile...', 'haoheng_huang.ai'],
  },
  ui: {
  ...
  hero: {
    ...
    currentFocus: {
      ...
      items: [
        ...
        'Contributing to the VerilogCoder research and engineering project',
      ],
    },
    cta: [
      { label: 'View Projects', link: 'projects', style: 'primary' },
      { label: 'Download Resume', link: 'resume', style: 'secondary', type: 'resume' },
      { label: 'Contact Me', link: 'contact', style: 'ghost' },
    ],
  },
  sections: {
    about: {
